...
namespace WinFormMiniMart
{
    public partial class Form4 : Form
    {
        ...
        private void numUD_UnitPrice_ValueChanged(object sender, EventArgs e)
        {

        }

        private void numUD_UnitsInStock_ValueChanged(object sender, EventArgs e)
        {

        }

        private void cmbDiscontinued_SelectedIndexChanged(object sender, EventArgs e)
        {
